...
export default function RoomDetails() {
  ...
  const { data: bookings, isLoading: bookingsLoading, error: bookingsError } = useQuery<Booking[]>({
    ...
    queryFn: async () => {
      const response = await axios.get(`https://meeting-room-booking-system-ten.vercel.app/api/booking/availablity/${id}`);
  ...
  const bookingMutation = useMutation({
    mutationFn: async () => {
      ...
      const response = await axios.post("https://meeting-room-booking-system-ten.vercel.app/api/booking", {
        roomId: id,
